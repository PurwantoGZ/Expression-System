...
namespace Emotion.Machine
{
    public class MySQL
    {
        ...
        #region GET OUTPUT
        public void getOutput(ref MetroComboBox cbOutput)
        {
        ...
        public void viewDataTraining(ref DataGridView dataTraining,string idUser) {
            ...
            if (this.OpenConnection()==true)
            {
                ...
                dataTraining.Columns[0].HeaderText = "F1";
                dataTraining.Columns[1].HeaderText = "F2";
                dataTraining.Columns[2].HeaderText = "F3";
                dataTraining.Columns[3].HeaderText = "F4";
                dataTraining.Columns[4].HeaderText = "F5";
                dataTraining.Columns[5].HeaderText = "F6";
                dataTraining.Columns[6].HeaderText = "Target";
                dataTraining.Columns[7].HeaderText = "User ID";
                dataTraining.Columns[0].Width = 70;
                ...
                dataTraining.Columns[6].Width = 60;
                dataTraining.Columns[7].Width = 160;
                this.CloseConnection();
            }
        }
        #endregion
